                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.portfolio-item.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio Title</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio Sub Title</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio Description</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Project Sub Title</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="project_sub_title" class="form-control" value="">
                                    </div>
                                </div>


                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Project Description</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="project_description" class="summernote"></textarea>
                                    </div>
                                </div>
...
{{-- 
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Project Sub Title </label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="project_sub_title_1" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Project Description</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="project_description_1" class="summernote"></textarea>
                                    </div>
                                </div>
